...
class LogController extends Controller
{
    ...
    public function logData(Request $request)
    {
        try{
            ...
            LogManager::scritturaLogs("operazini", 1, false, $request->ip(), Auth::id(), "Log di sistema", $request, $th);
            Session::flash("error", LogManager::messaggiOperazioni(1, false, "Log di sistema"));
